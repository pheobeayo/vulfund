...
const ProjectDetail = () => {
    ...
    return (
        <div className="p-8">
            ...
            <p className="text-[#3B3B3B] font-medium"><span className="text-[#015C28]">Total Amount Needed:</span>  {convertToWholeNumber(details.amount) / 1e18 }Matic 
                <br /><span className="text-[#110A03]">Total Donation Received:</span> {convertToWholeNumber(details.balance) / 1e18} Matic
